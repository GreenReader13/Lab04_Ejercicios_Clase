...
void myData()
{
	...
	GLfloat vertices[] = {
		//Position				//Textura
		-0.5f, -0.5f, 0.5f,		0.25f, 0.334f,	//V0 - Frontal
		0.5f, -0.5f, 0.5f,		0.5f, 0.334f,	//V1
		0.5f, 0.5f, 0.5f,		0.5f, 0.66f,	//V5
		-0.5f, 0.5f, 0.5f,		0.25f, 0.66f,	//V4

		0.5f, -0.5f, -0.5f,		0.75f, 0.333333f,	//V2 - Trasera
		-0.5f, -0.5f, -0.5f,	1.0f, 0.333333f,	//V3
		-0.5f, 0.5f, -0.5f,		1.0f, 0.666666f,	//V7
		0.5f, 0.5f, -0.5f,		0.75f, 0.666666f,	//V6

		-0.5f, 0.5f, 0.5f,		0.0f, 0.333333f,	//V4 - Izq
		-0.5f, 0.5f, -0.5f,		0.25f, 0.333333f,	//V7
		-0.5f, -0.5f, -0.5f,	0.25f, 0.666666f,	//V3
		-0.5f, -0.5f, 0.5f,		0.0f, 0.666666f,	//V0

		0.5f, 0.5f, 0.5f,		0.5f, 0.333333f,	//V5 - Der
		0.5f, -0.5f, 0.5f,		0.75f, 0.333333f,	//V1
		0.5f, -0.5f, -0.5f,		0.75f, 0.666666f,	//V2
		0.5f, 0.5f, -0.5f,		0.5f, 0.666666f,	//V6

		-0.5f, 0.5f, 0.5f,		0.25f, 0.666666f,	//V4 - Sup
		0.5f, 0.5f, 0.5f,		0.5f, 0.666666f,	//V5
		0.5f, 0.5f, -0.5f,		0.5f, 1.0f,	//V6
		-0.5f, 0.5f, -0.5f,		0.25f, 1.0f,	//V7

		-0.5f, -0.5f, 0.5f,		0.25f, 0.0f,	//V0 - Inf
		-0.5f, -0.5f, -0.5f,	0.5f, 0.0f,	//V3
		0.5f, -0.5f, -0.5f,		0.5f, 0.333333f,	//V2
		0.5f, -0.5f, 0.5f,		0.25f, 0.333333f,	//V1
	};
