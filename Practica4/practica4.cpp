...
void display(void)
{
	...
	model = glm::translate(glm::mat4(1.0f), glm::vec3(3.0, -1.75, 0));
	model = glm::scale(model, glm::vec3(2, 1, 1));
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 1.0f, 0.0f));
	projectionShader.setMat4("model", model);

	glDrawArrays(GL_QUADS, 0, 24); //Right shoulder
	...
	glDrawArrays(GL_QUADS, 0, 24); //Left shoulder

	model = glm::translate(glm::mat4(1.0f), glm::vec3(3.75, -3.75, 0));
	model = glm::scale(model, glm::vec3(0.5, 3, 1));
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.0f, 1.0f));
	projectionShader.setMat4("model", model);

	glDrawArrays(GL_QUADS, 0, 24); //Right arm
	...
	glDrawArrays(GL_QUADS, 0, 24); //Left arm
